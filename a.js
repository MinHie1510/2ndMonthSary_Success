...
async function menuju() { await swals.fire('Yessss!', 'Anhh có này tặng choo bbi nàa!', 'success'); window.location = "https://minhie1510.github.io/2ndMonthSary_Video/"; }
...
function aktipesan7() {
  ...
  new TypeIt("#pesan7", {
    ...
    afterComplete: function () {
      pesan7.innerHTML = vketik7; setTimeout(aktipesan8, 700);
    },
  }).go();
}
...
function checkslov() { if (slov == 5) { kolombaru.style = "position:relative;transform:scale(1)"; fthilang(); ftganti = 1; setTimeout(ftmuncul, 300); otomatis(); setTimeout(aktipesan2, 400); } }
